        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
          ...
          >
            <div className="relative w-full max-w-[180px] sm:max-w-[240px] lg:max-w-[280px] mx-auto">
              ...
              <div className="absolute inset-0 bg-blue-600/10 rounded-[4rem] blur-[60px] animate-pulse" />
              ...
              <div className={`relative aspect-square rounded-[2.5rem] lg:rounded-[3.5rem] overflow-hidden border-[1px] p-1.5 ${
                theme.theme === 'light' ? 'border-gray-200 bg-white shadow-lg' : 'border-white/10 bg-white/5 backdrop-blur-2xl'
              }`}>
                <div className="w-full h-full rounded-[2.2rem] lg:rounded-[3.2rem] overflow-hidden relative group">
                  <img
